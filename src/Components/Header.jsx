...
const Header = () => {
    ...
    return (
        <div>
            {/* Hamburger menu */}
            <div className="block md:hidden p-4 fixed z-50">
            ...
            {/* Sidebar */}
            <aside className={`fixed z-40 flex flex-col w-64 h-full px-4 py-8 overflow-y-auto bg-white border-r dark:bg-gray-900 dark:border-gray-700 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-200 ease-in-out`}>
