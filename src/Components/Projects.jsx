...
const Projects = () => {
    const projects = [
        {
            imgSrc: 'https://dummyimage.com/1920x1080/000/fff',
    ...
    return (
        <>
            <div id='Projects' className="relative isolate overflow-hidden bg-gray-900 md:ml-64">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-12">
                        {projects.map((project, index) => (
                            <div key={index} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <a href={project.link}>
                                    <img className="rounded-t-lg" src={project.imgSrc} alt={project.title} />
                                </a>
                                <div className="p-5">
                                    <a href={project.link}>
                                    ...
                                    <a
                                        href={project.link}
                                        className="inline-flex items-center px-3 py-2 my-5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    >
                                        Read more
                                        <svg
