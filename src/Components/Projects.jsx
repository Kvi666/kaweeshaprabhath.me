      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16 xl:px-20">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
            >
              <a href={project.link}>
                <img
              ...
              <div className="p-6">
                ...
                <a
                  href={project.link}
                  className="inline-flex items-center px-4 py-2 mt-6 text-sm font-medium text-white bg-sky-400 rounded-lg hover:bg-sky-600 focus:ring-4 focus:outline-none"
                >
                  Read more
                  <svg
