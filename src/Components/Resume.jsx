                                    ...
                                    <ul className="relative border-l-4 border-gray-600">
                                        ...
                                        <li className="mb-10 ml-8">
                                            ...
                                            <div className="absolute w-10 h-10 bg-gray-800 rounded-full -left-5 border-2 border-gray-600 flex items-center justify-center">
                                                <img src={Moratuwa_Logo} alt="Logo" className="w-full h-full object-contain p-1 rounded-full" />
                                            </div>
                                            <time className="block mb-2 text-sm font-mono italic text-gray-400">
                                                2022 - 2023
                                            </time>
                                            ...
                                            <p className="text-gray-400">
                                                Completed a Full Stack Development program at Moratuwa University, covering frontend and backend technologies. Gained skills in database management, server-side scripting, and dynamic web applications, preparing for comprehensive development roles.
                                            </p>
                                        ...
                                        <li className="mb-10 ml-8">
                                            <div className="absolute w-10 h-10 bg-gray-800 rounded-full -left-5 border-2 border-gray-600 flex items-center justify-center">
                                                <img src={Udemy_Logo} alt="Logo" className="w-full h-full object-contain p-1" />
                                            </div>
                                            <time className="block mb-2 text-sm font-mono italic text-gray-400">
                                                2023 - 2024
                                            </time>
                            ...
                            <div className="bg-gray-800 py-10">
                                ...
                                <div className="container mx-auto">
                                    <ul className="relative border-l-4 border-gray-600">
                                        ...
                                        <li className="mb-10 ml-8">
                                            <div className="absolute w-10 h-10 bg-gray-800 rounded-full -left-5 border-2 border-gray-600 flex items-center justify-center">
                                                <img src={Advirto_Logo} alt="Logo" className="w-full h-full object-contain p-1" />
                                            </div>
                                            <time className="block mb-2 text-sm font-mono italic text-gray-400">
                                                2023 - Present
                                            </time>
                                            ...
                                            <p className="text-gray-400">
                                                Leading web development at Advirto Digital, managing a team to design, develop, and deploy web solutions. Ensuring project success through effective coordination, innovative practices, and continuous workflow optimization.
                                            </p>
                                        </li>
                                        <li className="mb-10 ml-8">
                                            <div className="absolute w-10 h-10 bg-gray-800 rounded-full -left-5 border-2 border-gray-600 flex items-center justify-center">
                                                <img src={Esupport_Logo} alt="Logo" className="w-full h-full object-contain rounded-full p-1" />
                                            </div>
                                            <time className="block mb-2 text-sm font-mono italic text-gray-400">
                                                2023 - Present
                                            </time>
                                            ...
                                            <p className="text-gray-400">
                                                Working as a Web Developer at eSupport Technologies, responsible for creating and maintaining client websites.
                                                Collaborating on design, enhancing functionality, and ensuring a high-quality user experience with frontend and
                                        ...
                                        <li className="mb-10 ml-8">
                                            <div className="absolute w-10 h-10 bg-gray-800 rounded-full -left-5 border-2 border-gray-600 flex items-center justify-center">
                                                <img src={Fiverr_Logo} alt="Logo" className="w-full h-full object-contain p-1" />
                                            </div>
                                            <time className="block mb-2 text-sm font-mono italic text-gray-400">
                                                2022 - Present
                                            </time>
                                            ...
                                            <p className="text-gray-400">
                                                Providing freelance web development services on Fiverr, specializing in custom websites and e-commerce platforms. Managing projects from start to finish, leveraging HTML, CSS, JavaScript, and frameworks to meet diverse client needs.
                                            </p>
                                        </li>
                                    </ul>
                                </div>
