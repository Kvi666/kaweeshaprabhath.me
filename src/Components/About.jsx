      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="flex justify-center lg:justify-end lg:col-span-1">
            <img
              className="w-full h-auto max-w-xs lg:max-w-sm rounded-3xl"
              src={Dp}
              alt="About Me"
            />
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col justify-center items-center lg:items-start gap-8 lg:gap-12">
            ...
            {/* Button */}
            <button className="mt-6 px-6 py-3 bg-indigo-600 hover:bg-indigo-800 transition-all duration-500 ease-in-out rounded-lg shadow-md flex justify-center items-center">
