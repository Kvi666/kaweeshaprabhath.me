...
const Hero = () => {
    return (
        <div id='Home' className="relative isolate overflow-hidden bg-gray-900 md:ml-96"> {/* Add margin-left on medium screens and up */}
            <svg
            ...
            <div className="flex h-screen items-center justify-center">
                <div className="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
                    <h1 className="mt-10 text-5xl font-bold tracking-tight text-white sm:text-6xl">
                        ...
                        <span className="text-sky-500">Kvi</span>
                    </h1>
                    <p className="mt-6 text-lg leading-8 text-gray-300">
                        Elevate Your Productivity with Kvi: Your Personalized Web Development Assistant
                    </p>
